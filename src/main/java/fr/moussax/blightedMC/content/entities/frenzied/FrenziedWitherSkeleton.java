...
public final class FrenziedWitherSkeleton extends FrenziedAmbusher {
    public FrenziedWitherSkeleton() {
        super("FRENZIED_WITHER_SKELETON", "Frenzied Wither Skeleton", EntityType.WITHER_SKELETON);
