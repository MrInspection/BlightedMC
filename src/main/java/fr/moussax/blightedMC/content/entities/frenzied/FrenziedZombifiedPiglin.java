...
public final class FrenziedZombifiedPiglin extends FrenziedMeleeBruiser {

    public FrenziedZombifiedPiglin() {
        super("FRENZIED_ZOMBIFIED_PIGLIN", "Frenzied Zombified Piglin", EntityType.ZOMBIFIED_PIGLIN);
