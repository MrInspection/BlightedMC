...
public record SoundSequence(List<BlightedSound> sounds) {
    ...
    public static final SoundSequence FORGE_ITEM = new SoundSequence(
        new BlightedSound(Sound.ENTITY_IRON_GOLEM_REPAIR, 1f, 0.6f, 0L),
        new BlightedSound(Sound.ENTITY_IRON_GOLEM_REPAIR, 1f, 0.65f, 2L),
        new BlightedSound(Sound.ENTITY_IRON_GOLEM_REPAIR, 1f, 0.70f, 4L),
        new BlightedSound(Sound.ENTITY_IRON_GOLEM_REPAIR, 1f, 0.75f, 6L),
        new BlightedSound(Sound.ENTITY_IRON_GOLEM_REPAIR, 1f, 0.80f, 8L),
        new BlightedSound(Sound.ENTITY_IRON_GOLEM_REPAIR, 1f, 0.85f, 10L),
        new BlightedSound(Sound.ENTITY_IRON_GOLEM_REPAIR, 1f, 0.90f, 12L),
        new BlightedSound(Sound.ENTITY_IRON_GOLEM_REPAIR, 1f, 0.95f, 14L),
        new BlightedSound(Sound.ENTITY_IRON_GOLEM_REPAIR, 1f, 1.00f, 16L),
        new BlightedSound(Sound.ENTITY_IRON_GOLEM_REPAIR, 1f, 1.05f, 18L)
    );
