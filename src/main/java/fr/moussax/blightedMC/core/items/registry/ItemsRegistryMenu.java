...
public class ItemsRegistryMenu {
  ...
  public static class ItemCategoriesMenu extends Menu {
    public ItemCategoriesMenu() { super("§rItem Categories", 45); }
  ...
  public static class BlightedItemsPaginatedMenu extends PaginatedMenu {
    ...
    private void clearMenu() {
      for (int i = 0; i < size; i++) setItem(i, new ItemStack(Material.AIR), MenuItemInteraction.ANY_CLICK, (p, t) -> {});
    }
    ...
    private void setNavigation() {
      ...
      else setItem(48, MenuElementPreset.BACK_BUTTON, MenuItemInteraction.ANY_CLICK, (p, t) -> MenuManager.openMenu(previousMenu, p));
      ...
      else if (currentPage > 0) setItem(50, MenuElementPreset.EMPTY_SLOT_FILLER.getItem(), MenuItemInteraction.ANY_CLICK, (p, t) -> {});
