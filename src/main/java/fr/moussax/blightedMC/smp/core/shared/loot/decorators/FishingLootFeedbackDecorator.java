...
public final class FishingLootFeedbackDecorator implements FeedbackDecorator {
    ...
    public void execute(LootContext context, int amount) {
        ...
        String prefix = switch (quality) {
            case OUTSTANDING_CATCH -> " §6§lOUTSTANDING CATCH! §f| §7You caught §f";
            case GREAT_CATCH -> " §e§lGREAT CATCH! §f| §7You caught §f";
            case GOOD_CATCH -> " §a§lGOOD CATCH! §f| §7You caught §f";
            default -> null;
        };
