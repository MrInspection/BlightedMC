...
import fr.moussax.blightedMC.shared.ui.menu.interaction.MenuAction;
...
public abstract class Menu implements InventoryHolder {
    ...
    public void open(@NonNull Player player) {
        if (menuSystem == null && BlightedMC.getInstance() != null) {
            menuSystem = BlightedMC.getInstance().getMenuSystem();
        }
